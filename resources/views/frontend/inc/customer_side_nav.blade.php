<div class="sidebar sidebar--style-3 no-border stickyfill p-0">
    <div class="widget mb-0" style="background-color: #FCF8F0;">
        ...
        <div class="widget-profile-side">
            <ul class="categories categories--style-3">
                <span class="font-head-dashboard ml-3">MY ACCOUNT</span>
                <li>
                    <a href="{{ route('dashboard') }}" class="{{ areActiveRoutesHome(['dashboard'])}}">
                        <span class="font-dashboard">
                            {{__('Dashboard')}}
                        </span>
                    </a>
                </li>
               ...
               {{-- @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                ...
                <li>
                    <div class="name"><span class=" font-head-dashboard py-3 mb-0 ml-2" style="padding: 1rem 0.55rem;">HAPPY SKIN REWARD</span></div>
                </li>
                <li>
